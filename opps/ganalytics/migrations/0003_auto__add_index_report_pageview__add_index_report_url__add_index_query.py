...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Report', fields ['pageview']
        db.create_index(u'ganalytics_report', ['pageview'])

        # Adding index on 'Report', fields ['url']
        db.create_index(u'ganalytics_report', ['url'])

        # Adding index on 'Query', fields ['date_available']
        db.create_index(u'ganalytics_query', ['date_available'])

        # Adding index on 'Query', fields ['published']
        db.create_index(u'ganalytics_query', ['published'])


    def backwards(self, orm):
        # Removing index on 'Query', fields ['published']
        db.delete_index(u'ganalytics_query', ['published'])

        # Removing index on 'Query', fields ['date_available']
        db.delete_index(u'ganalytics_query', ['date_available'])

        # Removing index on 'Report', fields ['url']
        db.delete_index(u'ganalytics_report', ['url'])

        # Removing index on 'Report', fields ['pageview']
        db.delete_index(u'ganalytics_report', ['pageview'])
    ...
    models = {
        ...
        u'ganalytics.query': {
            ...
            'filter': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'query_filters'", 'to': u"orm['ganalytics.Filter']", 'through': u"orm['ganalytics.QueryFilter']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ganalytics.report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pageview': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
