...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ganalytics_queryfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'ganalytics', ['QueryFilter'])
        ...
        db.create_table(u'ganalytics_report', (
            ...
            ('pageview', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ...
            ('container', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='report_containers', null=True, on_delete=models.SET_NULL, to=orm['containers.Container'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ganalytics_queryfilter')
