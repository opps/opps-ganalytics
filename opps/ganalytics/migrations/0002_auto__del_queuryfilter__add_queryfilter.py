...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ganalytics_queuryfilter', (
            ('filter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='queryfilter_filters', null=True, to=orm['ganalytics.Filter'], on_delete=models.SET_NULL, blank=True)),
            ('query', self.gf('django.db.models.fields.related.ForeignKey')(related_name='queryfilter_queries', null=True, to=orm['ganalytics.Query'], on_delete=models.SET_NULL, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
